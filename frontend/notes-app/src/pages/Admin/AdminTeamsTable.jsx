...
export default function AdminTeamsTable() {
  ...
  const handleEdit = () => {
    console.log("Editing selected teams:", selectedRows);
    // Implement edit logic
  };

  const handleDelete = () => {
    console.log("Deleting selected teams:", selectedRows);
            ...
            <tbody>
              {filteredData.map((row, index) => (
                <tr key={row.id} className={`${index % 2 === 0 ? "bg-gray-800" : "bg-gray-700"} text-gray-300 hover:bg-gray-600`}>
                  ...
                  <td className="border border-gray-700 px-4 py-2">{row.team}</td>
                  <td className="border border-gray-700 px-4 py-2">{row.country}</td>
                  <td className="border border-gray-700 px-4 py-2">{row.hidden ? "Yes" : ""}</td>
                  <td className="border border-gray-700 px-4 py-2">{row.banned ? "Yes" : ""}</td>
                </tr>
              ))}
            </tbody>
          </table>
